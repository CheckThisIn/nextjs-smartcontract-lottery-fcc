...
This is a section of the Javascript Blockchain/Smart Contract FreeCodeCamp Course. Thank you ❤️ Patrick (@PatrickAlphaC):
...
```
git clone https://github.com/CheckThisIn/nextjs-smartcontract-lottery-fcc.git
...
[![Open in Gitpod](https://gitpod.io/button/open-in-gitpod.svg)](https://gitpod.io/#github.com/CheckThisIn/nextjs-smartcontract-lottery-fcc)
...
> You can read more about how to use that repo from its [README.md](https://github.com/CheckThisIn/hardhat-fund-me-fcc/blob/main/README.md)
